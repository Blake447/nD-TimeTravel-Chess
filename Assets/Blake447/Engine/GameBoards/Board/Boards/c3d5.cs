...
public class c3d5 : Board
{
    int[] board_dimensions = new int[3] { 5, 5, 5 };
    ...
    public override int[] PositionToCoordinate(Vector3 position)
    {
        ...
        offset = offset - Vector3.forward * 3.2f * offset_z;
        ...
        int[] coordinate = new int[3] { offset_x, offset_y, offset_z };
    ...
    public override Vector3 CoordinateToPosition(int[] coordinate)
    {
        ...
        //position = position + new Vector3(2.0f, 2.0f);
        position = position + z * new Vector3(0, 0, 3.2f);
    ...
    public override Vector3 SnapCamera(Vector3 position)
    {
        ...
        if (coordinate != null)
        {
            ...
            Vector3 b = CoordinateToPosition(new int[3] { 3, 3, coordinate[2] });
            Vector3 m = (a + b) * 0.5f;
            return m;
        }
        return position;
    ...
    public override Vector3 GetCenter()
    {
        ...
        Vector3 a2 = CoordinateToPosition(new int[] { 4, 4, 4 });
