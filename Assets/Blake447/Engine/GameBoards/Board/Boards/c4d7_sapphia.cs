...
public class c4d7_sapphia : Board
{
    int[] board_dimensions = new int[4] { 7, 7, 7, 7 };
    ...
    public override int[] PositionToCoordinate(Vector3 position)
    {
        ...
        offset = offset - Vector3.right * 8.0f * offset_z;
    ...
    public override Vector3 CoordinateToPosition(int[] coordinate)
    {
        ...
        //position = position + new Vector3(2.0f, 2.0f);
        position = position + z * new Vector3(8, 0, 0);
    ...
    public override Vector3 SnapCamera(Vector3 position)
    {
        ...
        if (coordinate != null)
        {
            ...
            Vector3 b = CoordinateToPosition(new int[4] { 6, 6, coordinate[2], coordinate[3] });
            Vector3 m = (a + b) * 0.5f;
            return m;
        }
        return position;
    ...
    public override Vector3 GetCenter()
    {
        ...
        Vector3 a2 = CoordinateToPosition(new int[] { 6, 6, 6, 6 });
